...
def create_task_management_message():
    ...
    message = (
        ...
        .add_actions([
            ...
            MultiStaticSelect.create("assignee_filter", "Assignees", [], assignee_options)
        ])
        .add_divider()
...
def create_survey_message():
    ...
    message = (
        ...
        .add_actions([
            RadioButtons.create("rating_radio", rating_options)
        ])
        ...
        .add_input(
            ...
            PlainTextInput.create("contact_email")
        ...
        .add_input(
            ...
            DatePicker.create("last_used_date")
...
def create_approval_workflow_message():
    ...
    message = (
        ...
        .add_actions([
            StaticSelect.create("rejection_reason", "Select reason", rejection_reasons)
        ])
        .add_input(
            "Additional comments",
